...
python ../flatten.py --input-path=../../data/ost_proposed/dialogs/train.txt --num-contexts=${NUM_CONTEXTS} --output-path=dirty_train.csv
python ../flatten.py --input-path=../../data/ost_proposed/dialogs/valid.txt --num-contexts=${NUM_CONTEXTS} --output-path=dirty_valid.csv
python ../flatten.py --input-path=../../data/ost_proposed/dialogs/test.txt --num-contexts=${NUM_CONTEXTS} --output-path=dirty_test.csv
